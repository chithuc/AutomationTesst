...
//    @Test(description = "Login | validate phone and password: wrong format")
//    @Severity(SeverityLevel.BLOCKER)
//    @Description("Login successful with phone number and password wrong format")
//    public void Test_03_loginWithUserNameAndPasswordIsEmpty()  {
//        tikiHomePage.navigate_Tiki_Url(Constants.TIKI_URL)
//                .clickLoginOrSignUpButton();
//        PageFactoryManager.get(LoginPage.class)
//                .inputPhoneNumber(TikiData.phoneNumberWrongFormat)
//                .clickContinueButton()
//                .verifyInputInvalidValue(Constants.VALIDATE_MESSAGE[0])
//                .clearPhoneNumber()
//                .inputPhoneNumber(TikiData.phoneNumber)
