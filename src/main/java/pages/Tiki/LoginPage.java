...
//    public LoginPage clearPhoneNumber() {
//        scrollTo(PHONE_TEXT_BOX);
//        clearTextElement(PHONE_TEXT_BOX);
//        return this;
//    }
    ...
    @Step("Verify when input phone number is wrong format")
    public LoginPage verifyInputWrongFormat(String validateMessage) {
        Assert.assertTrue(isControlDisplayed(VALIDATE_MESSAGE,validateMessage));
        return this;
    }
}
